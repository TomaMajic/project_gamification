...
Level.create(concept_id: 7, level_no: 4)
Level.create(concept_id: 7, level_no: 5)
Level.create(concept_id: 7, level_no: 6)
Level.create(concept_id: 7, level_no: 7)
Level.create(concept_id: 7, level_no: 8)
Level.create(concept_id: 7, level_no: 9)
